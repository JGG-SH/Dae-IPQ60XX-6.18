...
# sed -i "/^define Device\/link_nn6000-v2/,/^endef/ { /^endef/i\\tKERNEL_SIZE := 12288k }" $image_file
# sed -i "/^define Device\/link_nn6000-v2/,/^endef/ { /KERNEL_SIZE := 6144k/s//KERNEL_SIZE := 12288k/ }"
